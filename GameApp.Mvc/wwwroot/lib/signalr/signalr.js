(function webpackUniversalModuleDefinition(root, factory) {
	...
	return /******/ (() => {
		...
		class HubConnection {
			...
			constructor(
				...
				this.serverTimeoutInMilliseconds =
					serverTimeoutInMilliseconds !== null && serverTimeoutInMilliseconds !== void 0
						? serverTimeoutInMilliseconds
				...
				this._statefulReconnectBufferSize =
					statefulReconnectBufferSize !== null && statefulReconnectBufferSize !== void 0
						? statefulReconnectBufferSize
		...
		class AccessTokenHttpClient extends HttpClient {
			...
			async send(request) {
				...
				if (
					...
					(!this._accessToken || (request.url && request.url.indexOf('/negotiate?') > 0))
				) {
		...
		class WebSocketTransport {
			...
			_isCloseEvent(event) {
				return (
					event && typeof event.wasClean === 'boolean' && typeof event.code === 'number'
				);
			}
		...
		class PromiseSource {
			constructor() {
				this.promise = new Promise(
					(resolve, reject) => ([this._resolver, this._rejecter] = [resolve, reject]),
				);
			}
			resolve() {
				this._resolver();
